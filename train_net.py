...
@Date           : 2020-04-27 16:40:13
@FilePath       : /ImageCls.detectron2/train_net.py
@Description    : 
'''
...
def main_worker(gpu, ngpus_per_node, args, cfg):
    ...
    normalize = transforms.Normalize(mean=[103.530, 116.280, 123.675], # [0.485, 0.456, 0.406],
                                     std=[1.0, 1.0, 1.0])# std=[0.229, 0.224, 0.225])
...
def train(train_loader, model, criterion, optimizer, epoch, args):
    ...
    for i, (images, target) in enumerate(train_loader):
        ...
        # compute output
        # output = model.module.forward_imagenet(images)
        output = model(images)
